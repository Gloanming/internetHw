...
public class addActivityVo {
    ...
    public addActivityVo(String creatorId, String  activityId, String activityType, String head, String content, String startTime, String endTime, int viewCount, int capacity, int bookCount, int likeCount, String activityCoverUrl) {
